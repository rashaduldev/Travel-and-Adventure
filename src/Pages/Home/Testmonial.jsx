...
const Testmonial = () => {
    return (
        <div>
            <div className="space-y-5 mx-10 my-20">
                <div className="text-center">
                    <h2 className="italic text-2xl">Testmonial</h2>
                    <h1 className="text-5xl font-bold">What your customar  <br /> says about us</h1>
                </div>
                <div className="">
  ...
  <div className="relative z-10">
    <p className="text-gray-800 sm:text-xl dark:text-white text-center"><em>
      I just wanted to say that I am very happy with my purchase so far. <br /> The documentation is outstanding - clear and detailed.
    </em></p>
  </div>
  ...
  <footer className="mt-6">
    <div className="flex items-center mx-auto justify-center">
      ...
      <div className="ms-4">
        <div className="text-base font-semibold text-gray-800 dark:text-gray-400">Josh Grazioso</div>
